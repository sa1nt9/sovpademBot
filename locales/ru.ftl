...
can_add_to_blacklist_only_while_searching = В черный список можно добавить пользователя только при просмотре его анкеты
...
stats_users_in_blacklist = 🚫 Пользователей в чёрном списке: {$count}  /blacklist
...
candidates_ended = Вы просмотрели всех доступных для вас пользователей на данный момент. Возвращайтесь позже!
...
more_options_blacklist_confirm = Вы уверены, что хотите добавить этого пользователя в черный список?
more_options_blacklist_success = Пользователь добавлен в черный список. Введи /blacklist, чтобы посмотреть чёрный список
more_options_blacklist_already = Этот пользователь уже в черном списке

# Черный список
blacklist_empty = 🚫 Твой черный список пуст

blacklist_user_info = 👤 Пользователь из черного списка{ $count ->
        [0] :
        *[other] (и ещё { $count })
    }

blacklist_no_more_users = Больше нету пользователей в чёрном списке

blacklist_remove = ❌ Убрать из черного списка

see_next = Смотреть дальше

blacklist_remove_success = Пользователь удален из черного списка

blacklist_remove_error = Произошла ошибка при удалении пользователя из черного списка
